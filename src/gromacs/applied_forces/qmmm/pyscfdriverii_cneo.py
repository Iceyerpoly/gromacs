...
def qmmmCalc(qmbasis, qmmult, qmcharge,
    ...
    for link in links:
        ...
        mmcharges_redist = charge_redist(hostindex, neighbor_index=neighbor_index, mmindex=mmindex, mmcharges=mmcharges_redist)
    ...
    # energy
    mf = neo.CDFT(mol_neo, df_ee=True, auxbasis_e=qmauxbasis)
    mf.mf_elec.xc = 'B3LYP'
    energy = mf.kernel()
    te = time.time()
